...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public Fragment movimentoFragment;
    ...
    public void onShowPedido() {
        if (Constants.PERMISSION.ACCESS_FINE_LOCATION == PackageManager.PERMISSION_DENIED) {
            ...
            Constants.MOVIMENTO.movimento = new Movimento(Constants.MOVIMENTO.codigoempresa,
                    ...
                    null, "", new BigDecimal("0"), "", Misc.GetDateAtual(), null, null, null, Misc.gerarMD5(), "", "", 0, 0, 0, 0, "F");


            LocalizacaoTask localizacaoTask = new LocalizacaoTask(this, true);
            localizacaoTask.execute();
        }
    }

    public void onPedido(){
        Misc.onSetGPS(this, Constants.MOVIMENTO.movimento, true);
