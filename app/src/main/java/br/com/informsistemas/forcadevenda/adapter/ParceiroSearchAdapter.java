...
public class ParceiroSearchAdapter extends RecyclerView.Adapter<ParceiroViewHolder>  {
    ...
    public ParceiroSearchAdapter(Context c, List<Parceiro> list, ParceiroViewHolder.onParceiroListener onParceiroListener){
        this.fList = list;
        this.context = c;
