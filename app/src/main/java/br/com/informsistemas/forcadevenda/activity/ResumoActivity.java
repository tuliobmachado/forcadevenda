...
public class ResumoActivity extends AppCompatActivity {
    ...
    private CheckBox chkAtualizarLocalizacao;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chkAtualizarLocalizacao = findViewById(R.id.chk_atualizar_localizacao);
        ...
        if (Constants.MOVIMENTO.movimento.atualizarlocalizacao.equals("F")){
            chkAtualizarLocalizacao.setChecked(false);
        }else{
            chkAtualizarLocalizacao.setChecked(true);
        }
    ...
    private void enviarSalvarPedido(Boolean enviar) {
        ...
        if (chkAtualizarLocalizacao.isChecked()){
            Constants.MOVIMENTO.movimento.atualizarlocalizacao = "T";
        }else{
            Constants.MOVIMENTO.movimento.atualizarlocalizacao = "F";
        }
